...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        ParseSwift.initialize(applicationId: "Diyl3UjkyAzbP4JvX7J2MtQrAM2Yc7yUSPcNUN41",
                              clientKey: "tflpBoEwE979fEi2lcww5FUw0FLz438isWyMJRAj",
...
// Sample Usage
//
// let score = Score(playerName: "Kingsley", points: 13)
